...
class ProductRepositoryTest(
    ...
    fun readSavedDb() {
        ...
        val mediaSet = setOf(
            MediaInfo(
                text = "media 1", uri = "http://media1", type = MediaType.IMAGE, source = MediaSourceType.HMDB,
                sourceUri = "http://media1", priority = 1
            ),
            MediaInfo(
                text = "media 2", uri = "http://media2", type = MediaType.IMAGE, source = MediaSourceType.HMDB,
        ...
        runBlocking {
            ...
            productRepository.save(
                Product(
                    supplierId = supplier.id,
                    identifier = "124",
                    title = "Dette er et produkt2",
                    articleName = "Produkt 2",
                    mainProduct = false,
                    accessory = true,
                    sparePart = false,
                    supplierRef = "124",
            ...
            val accessory = productRepository.findBySupplierIdAndSupplierRef(supplier.id, "124")
            accessory.shouldNotBeNull()
            accessory.mainProduct shouldBe false
            accessory.accessory shouldBe true
            accessory.sparePart shouldBe false
        }
    }
}
